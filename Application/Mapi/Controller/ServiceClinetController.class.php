...
class ServiceClinetController extends CommonController
{
    ...
    //4、进行握手 流程是接收websocket内    容从Sec-WebSocket-Key:中获取key并通过加密算法写�    �缓冲区客户端会进行验证（自动验证不需要我们处理）
