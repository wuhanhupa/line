        ...
        <p><?php echo ($prompt_text); ?></p>
            ...
            <div class="cnyin_record f_body">
                <table class="f_table" id="investLog_content">
                    <thead>
                        <tr>
                            <th><img src="/Upload/coin/<?php echo ($coin_list[$market_list[$market]['xnb']]['img']); ?>"
                                    alt="" style="margin-bottom: -5px; width: 22px;" /> <select name="market-selectTest"
                                    id="market-selectTest">
                            ...
                            <th><select name="status-selectTest" id="status-selectTest">
                                    <option value="0" <?php if(($status) == "0"): ?>selected<?php endif; ?>>---全部---
                                    </option>
                                    <option value="1" <?php if(($status) == "1"): ?>selected<?php endif; ?>>交易中
                                    </option>
                                    <option value="2" <?php if(($status) == "2"): ?>selected<?php endif; ?>>已完成
                                    </option>
                                    <option value="3" <?php if(($status) == "3"): ?>selected<?php endif; ?>>已撤销
                                    </option>
                                </select></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td>
                                    <?php if(($vo["type"]) == "1"): ?><font class="buy">买入</font>
                                        <?php else: ?>
                                        <font class="sell">卖出</font><?php endif; ?>
                                </td>
                                <td><?php echo (NumToStr($vo['price'])); ?></td>
                                <td><?php echo (NumToStr($vo['num'])); ?></td>
                                <td><?php echo (NumToStr($vo['deal'])); ?></td>
                                <td>
                                    <?php if(($vo["status"]) == "0"): ?>交易中 | <a class="cancel" id="<?php echo ($vo["id"]); ?>"
                                            href="javascript:void(0);">撤销</a><?php endif; ?>
                ...
                <table class="f_table" id="investLog_content">
                    ...
                    <tbody>
                        <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                               ...
                               <td width=""><?php echo ($vo["exchanged_amount"]); ?></td>
                               <td width=""><?php echo ($vo["remaining"]); ?></td>
                               <td width="">-.--</td>
                               <td width=""><?php echo ($vo["price"]); ?></td>
                               <td width=""><?php echo ($vo["close_type"]); ?></td>
                               <td width=""><?php echo ($vo["status"]); ?></td>
                               <td width=""><?php echo ($vo["id"]); ?></td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
...
<script>
    ...
    $('.gui-accounts-container').on('click','.gui-account',function() {
         ...
         window.location.href = "/finance/mywt.html?cate=" + cate;
     })
