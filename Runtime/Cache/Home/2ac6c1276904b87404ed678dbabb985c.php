...
<div class="autobox">
 <div class="now">
  <a href="/" class="orange">首页</a> &gt;<a href="<?php echo U('Article/index');?>" class="orange"> <?php echo ($shang["title"]); ?> </a>
 </div>
  ...
  <div class="coin_menu">
   <div class="coin_menu_box">
    <?php if(is_array($ArticleTypeList)): $index = 0; $__LIST__ = $ArticleTypeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($index % 2 );++$index;?><dl>
     <dt <?php if(($shang['name']) == $key): ?>class="here"<?php endif; ?>>
  ...
  <div class="assets_content w900 right bg_w mh1500">
   ...
   <div class="new_list">
    <ul>
      ...
      <span class="list_time" style="float: right;"><?php echo (addtime($vo["addtime"])); ?></span>
      </li><?php endforeach; endif; else: echo "" ;endif; ?>
