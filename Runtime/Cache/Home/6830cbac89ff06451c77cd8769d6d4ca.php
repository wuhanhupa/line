...
<div class="autobox">
    ...
    <div class="coin_menu_box">
        <ul>
            <li id="user_index">
                <i class="ui-icon ui-icon-ai-safe"></i><a href="<?php echo U('User/index');?>">安全中心</a>
            </li>
            <li id="user_nameauth">
                <i class="ui-icon ui-icon-Id"></i><a href="<?php echo U('User/nameauth');?>">实名认证</a>
            </li>
            <li id="user_password">
                <i class="ui-icon ui-icon-mima"></i><a href="<?php echo U('User/password');?>">修改登录密码</a>
            </li>
            <li id="user_paypassword">
                <i class="ui-icon ui-icon-mima"></i><a href="<?php echo U('User/paypassword');?>">修改交易密码</a>
            </li>
            <!-- <li id="user_ga">
                <i class="coin_menu_op_11_1"></i><a href="<?php echo U('User/ga');?>">设置双重验证</a>
            </li> -->
            <!-- <li id="user_tpwdset">
                <i class="coin_menu_op_15_1"></i><a href="<?php echo U('User/tpwdset');?>">交易密码输入设置</a>
            </li> -->
            <!--<li id="user_moble">
                <i class="coin_menu_op_12_1"></i><a href="<?php echo U('User/moble');?>">手机绑定</a>
            </li>-->
            <li id="user_bank">
                <i class="ui-icon ui-icon-bank"></i><a href=" <?php echo U('User/bank');?>">银行卡管理</a>
            </li>
            <li id="user_bind_alipay">
                <i class="ui-icon ui-icon-zhifubao"></i><a href=" <?php echo U('User/alipay');?>">支付宝绑定</a>
            </li>
            <!--<li id="user_bind_wx">
                <i class="ui-icon ui-icon-weixin"></i><a href=" <?php echo U('User/wxinfo');?>">微信绑定</a>
            </li>
            <li id="user_qianbao">
                <i class="ui-icon ui-icon-qianbao"></i><a href=" <?php echo U('User/qianbao');?>">钱包地址管理</a>
            </li>-->
            <!-- <li id="user_goods">
                <i class="coin_menu_op_13_1"></i><a href=" <?php echo U('User/goods');?>">联系地址管理</a>
            </li> -->
            <li id="user_log">
                <i class="ui-icon ui-icon-log"></i><a href=" <?php echo U('User/log');?>">登录日志</a>
            </li>
        </ul>
    </div>
</div>
    <!--右侧内容-->
    <div class="assets-content assets_content w900 right bg_w" id="safebox">
        <div class="ui-title">
            <span>安全中心</span>
        </div>
   ...
   <div class="safe_center clear">
    <div class="sc_level">
     <?php if(($user['ident_status'] == 0)): ?><div class="sc_level_4"></div>
     <?php elseif(($user['ident_status'] == 3)): ?>
      <div class="sc_level_4"></div>
     <?php elseif(($user['ident_status'] == 1)): ?>
      <div class="sc_level_2"></div>
     <?php else: ?>
     <div class="sc_level_1"></div><?php endif; ?>
    </div>
    <dl>
     <dt>
      ID：<span><?php echo ($user["id"]); ?></span>
     </dt>
     <dd>姓名：<?php echo ($user["truename"]); ?></dd>
     <dd>用户名：<?php echo ($user["username"]); ?></dd>
    </dl>
   </div>
   <ul class="sc_statu">
    <li><em class="sc_statu_type_1"></em>
     <dl>
      <dt>实名认证</dt>
       <?php if(($user['ident_status'] == 0)): ?><dd class="nopass">
          <span>请去认证</span><a href="/user/nameauth.html">查看</a>
        </dd>
        <?php elseif(($user['ident_status'] == 1)): ?>
         <dd class="nopass">
          <spa>审核中</span><a href="/user/nameauth.html">查看</a>
        </dd>
        <?php elseif(($user['ident_status'] == 3)): ?>
         <dd class="nopass">
          <span>审核未通过</span><a href="/user/nameauth.html">查看</a>
        </dd>
        <?php else: ?>
        <dd class="alpass">
    ...
    <li><?php if(empty($user['moble'])): ?><em class="sc_statu_type_3_1"></em>
     <dl>
      <dt>绑定手机</dt>
      <dd class="nopass">
       未认证 <a href="/user/moble.html">查看</a>
      </dd>
     </dl>
     <?php else: ?> <em class="sc_statu_type_3"></em>
     <dl>
      <dt>绑定手机</dt>
      <dd class="alpass">
       已认证 <a href="/user/moble.html">查看</a>
      </dd>
     </dl><?php endif; ?>
   </li>
   </ul>
   <div class="sc_info_list" id="sc_info_list">
    ...
    <dl>
     ...
     <dd>
      <div class="changepw">
       <a href="/user/paypassword.html">修改交易密码</a>
      </div>
     </dd>
    </dl>
    <dl>
     <dt>实名认证</dt>
     <dd>
      <p>受国家要求及为了您的资金安全需进行实名认证</p>
     </dd>
     <dd>
       <?php if(($user['ident_status'] == 0)): ?><div class="changepw">
           <span style="color: red">待认证</span>,请上传身份证照片 <a href="/user/nameauth.html">查看</a>
         </div>
       <?php elseif(($user['ident_status'] == 1)): ?>
        <div class="changepw">
           <span style="color: red">审核中请您耐心等待</span> <a href="/user/nameauth.html">查看</a>
         </div>
        <?php elseif(($user['ident_status'] == 3)): ?>
        <div class="changepw">
           <span style="color: red">审核未通过请重新上传</span> <a href="/user/nameauth.html">查看</a>
         </div> 
       <?php else: ?>
         <div class="changepw">
           已认证 <a href="/user/nameauth.html">查看</a>
    ...
    <dl>
     ...
     <dd>
      <div class="changepw">
       <?php if(empty($user['moble'])): ?>未认证 ｜ <a href="/user/nameauth.html">立即认证</a> <?php else: ?> <a href="/user/moble.html">查看</a><?php endif; ?>
      </div>
     </dd>
    </dl>
   </div>
