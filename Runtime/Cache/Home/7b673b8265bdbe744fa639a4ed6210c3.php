...
<div class="wrapbody">
	<div class="main">
		<div class="myright" style="width: 1200px;padding: 0px;margin-top: 20px;">
			<div class="wraphtml">
    ...
    <div class="maintain-content">
        <div class="coin-intro">
            <h4 class="intro-title" style="margin-top:0;"><?php echo ($coin['title']); ?>(<?php echo (strtoupper($xnb)); ?>)介绍</h4>
            <div class="left-icon-area">
                <div style="width:80px;height:80px; border:1px solid #dcdcdc;"><img width="80" height="80" src="/Upload/coin/<?php echo ($coin['img']); ?>" alt=""></div>
            </div>
            <div class="right-detail-area">
                <div style="border-bottom:1px dotted #dcdcdc;">
                    <h4 class="coin-detail-title"><?php echo ($market_list[$market]['xnbtitle']); ?>(英文：<?php echo ($coin['js_yw']); ?> 缩写：<?php echo (strtoupper($xnb)); ?>)</h4>
                    <h5 style="padding:8px 0;font-weight:normal;color:#777;text-align: left;">推出日期：<?php echo ($coin['cs_fb']); ?></h5>
                </div>
                <p><?php echo (htmlspecialchars_decode($coin['js_sm'])); ?></p>
            </div>
        </div>
        <div class="link-cc">
            <h4 class="intro-title">常用链接</h4>
            <ul>
<li style="margin-left:0;"><a target="_blank" class="btn-usul" href="<?php echo ($coin['js_qb']); ?>"><?php echo ($coin['title']); ?>钱包下载</a></li>
<li><a target="_blank" class="btn-usul" href="<?php echo ($coin['js_ym']); ?>"><?php echo ($coin['title']); ?>源码下载</a></li>
<li><a target="_blank" class="btn-usul" href="<?php echo ($coin['js_gw']); ?>"><?php echo ($coin['title']); ?>官方网站</a></li>
<li><a target="_blank" class="btn-usul" href="<?php echo ($coin['js_lt']); ?>"><?php echo ($coin['title']); ?>论坛</a></li>
<li><a target="_blank" class="btn-usul" href="<?php echo ($coin['js_wk']); ?>"><?php echo ($coin['title']); ?>挖矿</a></li>
</ul>
        </div>
        <div class="detail-Parameter">
            <h4 class="intro-title">详细参数</h4>
            <table class="Parameter-table" >
				<tbody><tr>
					<td><span>中文名：</span><?php echo ($coin['title']); ?></td>
					<td><span>英文名：</span><?php echo ($coin['js_yw']); ?></td>
					<td><span>英文简称：</span><?php echo (strtoupper($xnb)); ?></td>
				</tr>
				<tr>
					<td><span>研发者：</span><?php echo ($coin['cs_yf']); ?></td>
					<td><span>核心算法：</span><?php echo ($coin['cs_sf']); ?></td>
					<td><span>发布日期：</span><?php echo ($coin['cs_fb']); ?></td>
				</tr>
				<tr>
					<td><span>区块速度：</span><?php echo ($coin['cs_qk']); ?></td>
					<td><span>发行总量：</span><?php echo ($coin['cs_zl']); ?></td>
					<td><span>流通量：</span><?php echo ($coin['cs_cl']); ?></td>
				</tr>
				<tr>
					<td><span>证明方式：</span><?php echo ($coin['cs_zm']); ?></td>
					<td><span>难度调整：</span><?php echo ($coin['cs_nd']); ?></td>
					<td><span>区块奖励：</span><?php echo ($coin['cs_jl']); ?></td>
				</tr>
				<tr>
					<td colspan="3"><span>主要特色：</span><?php echo ($coin['cs_ts']); ?></td>
				</tr>
				<tr>
					<td colspan="3"><span>不足之处：</span><?php echo ($coin['cs_bz']); ?></td>
				</tr>
			</tbody></table>
        </div>
    </div>
