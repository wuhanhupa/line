                ...
                <div class="sleft">
                    <form name="formSearch" id="formSearch" method="get" name="form1">
                        ...
                        <select style="width: 160px; float: left; margin-right: 10px;" name="status" class="form-control">
							...
							>交易中</option>
							<option value="8"
							<?php if(($_GET['status']) == "8"): ?>selected<?php endif; ?>
                            >交易完成后</option>
                            <option value="16"
                            <?php if(($_GET['status']) == "16"): ?>selected<?php endif; ?>
							>撤单</option>
						</select>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($vo["originOrderId"]); ?></td>
                            <td><?php echo ($vo['platformOrderId']); ?> </td>
                            <td><?php echo ($vo["pair"]); ?></td>
                            <td>
                                <?php if(($vo["bidFlag"]) == "1"): ?>买<?php endif; ?>
                                <?php if(($vo["bidFlag"]) == "0"): ?>卖<?php endif; ?>
                            </td>
                            <td><?php echo ($vo["originAmount"]); ?></td>
                            <td><?php echo ($vo["amount"]); ?></td>
                            <td><?php echo ($vo["originPrice"]); ?></td>
                            <td><?php echo ($vo["platformPrice"]); ?></td>
                            <td>
                                <?php if(($vo["orderStatus"]) == "1"): ?>下单失败<?php endif; ?>
                                <?php if(($vo["orderStatus"]) == "2"): ?>下单成功<?php endif; ?>
                                <?php if(($vo["orderStatus"]) == "4"): ?>交易中<?php endif; ?>
                                <?php if(($vo["orderStatus"]) == "8"): ?>交易完成后<?php endif; ?>
                                <?php if(($vo["orderStatus"]) == "16"): ?>撤单<?php endif; ?>
                            </td>
                            <td>
                                <?php if(($vo["platformSystem"]) == "1"): ?>未知<?php endif; ?>
                                <?php if(($vo["platformSystem"]) == "2"): ?>未知<?php endif; ?>
                                <?php if(($vo["platformSystem"]) == "3"): ?>ZB<?php endif; ?>
                            </td>
                            <td><?php echo ($vo["remark"]); ?></td>
                            <td><?php echo (get_microtime_format($vo["ctime"])); ?></td>
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Finance/robotall');?>");
    </script>