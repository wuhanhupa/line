				...
				<div class="sleft">
					<form name="formSearch" id="formSearch" method="get" name="form1">
						...
						<select style="width: 160px; float: left; margin-right: 10px;" name="ident_status" class="form-control">
							<option value=""<?php if(empty($_GET['ident_status'])): ?>selected<?php endif; ?>>审核状态</option>
							<option value="0"<?php if(($_GET['ident_status']) == "0"): ?>selected<?php endif; ?>>未审核</option>
							<option value="1"<?php if(($_GET['ident_status']) == "1"): ?>selected<?php endif; ?>>待审核</option>
							<option value="2"<?php if(($_GET['ident_status']) == "2"): ?>selected<?php endif; ?>>已通过</option>
						</select>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
								<?php if(($vo["ident_status"]) == "0"): ?>未审核<?php endif; ?>
								<?php if(($vo["ident_status"]) == "1"): ?>待审核<?php endif; ?>
								<?php if(($vo["ident_status"]) == "2"): ?>已通过<?php endif; ?>
								<?php if(($vo["ident_status"]) == "3"): ?>不通过<?php endif; ?>
							</td>
							<td>
