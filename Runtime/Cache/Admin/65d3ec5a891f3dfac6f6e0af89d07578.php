...
<div id="main-content">
    ...
    <div id="main" class="main">
        <div class="main-title-h">
            <span class="h1-title">搬币机器人当前余额</span>
        </div>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($data)): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <?php if(($vo["coin"]) == "USDT"): ?><td><span style="color:red;"><?php echo ($vo["coin"]); ?></span></td>
                                <td><span style="color:red;"><?php echo ($vo["available"]); ?></span></td>
                            <?php else: ?>
                                <td><?php echo ($vo["coin"]); ?></td>
                                <td><?php echo ($vo["available"]); ?></td><?php endif; ?>
                            <td><?php echo ($vo["freez"]); ?></td>
                            <td><?php echo (get_microtime_format($vo["timestamp"])); ?></td>
                            <!--<td>
                                <?php if(($vo["coin"]) == "USDT"): ?><button class="btn btn-xs submit-btn ajax-post" id="shenhe" type="button" target-form="form-horizontal">短信告警</button><?php endif; ?>
                            </td>-->
...
//			});
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Finance/robot');?>");
        ...
        function shehe(type){
            $.ajax({
                type:'post',
                url:"<?php echo U('Admin/Finance/notice');?>",
                data:{
                    type:type
                },
